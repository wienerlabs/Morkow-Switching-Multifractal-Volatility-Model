...
LAUNCH_TRACKER_ENABLED = os.environ.get("LAUNCH_TRACKER_ENABLED", "false").lower() == "true"
LAUNCH_TRACKER_MAX_AGE_HOURS = float(os.environ.get("LAUNCH_TRACKER_MAX_AGE_HOURS", "24.0"))
LAUNCH_TRACKER_BUNDLE_WINDOW_SEC = float(os.environ.get("LAUNCH_TRACKER_BUNDLE_WINDOW_SEC", "30.0"))
LAUNCH_TRACKER_BUNDLE_MIN_WALLETS = int(os.environ.get("LAUNCH_TRACKER_BUNDLE_MIN_WALLETS", "3"))
LAUNCH_TRACKER_CEX_SCORE = int(os.environ.get("LAUNCH_TRACKER_CEX_SCORE", "25"))
LAUNCH_TRACKER_BUNDLE_SCORE = int(os.environ.get("LAUNCH_TRACKER_BUNDLE_SCORE", "30"))
LAUNCH_TRACKER_FAST_DEPLOY_SCORE = int(os.environ.get("LAUNCH_TRACKER_FAST_DEPLOY_SCORE", "15"))
LAUNCH_TRACKER_CONCENTRATION_SCORE = int(os.environ.get("LAUNCH_TRACKER_CONCENTRATION_SCORE", "20"))
LAUNCH_TRACKER_YOUNG_DEPLOYER_SCORE = int(os.environ.get("LAUNCH_TRACKER_YOUNG_DEPLOYER_SCORE", "10"))
LAUNCH_TRACKER_VETO_THRESHOLD = int(os.environ.get("LAUNCH_TRACKER_VETO_THRESHOLD", "90"))

# ── Ghost Watcher (Phase 15) — Dormant Wallet Reactivation ──

GHOST_WATCHER_ENABLED = os.environ.get("GHOST_WATCHER_ENABLED", "false").lower() == "true"
GHOST_WATCHER_DORMANCY_THRESHOLD_DAYS = float(os.environ.get("GHOST_WATCHER_DORMANCY_THRESHOLD_DAYS", "90.0"))
GHOST_WATCHER_MIN_HOLDER_PCT = float(os.environ.get("GHOST_WATCHER_MIN_HOLDER_PCT", "0.5"))
GHOST_WATCHER_MAX_WALLETS_TO_CHECK = int(os.environ.get("GHOST_WATCHER_MAX_WALLETS_TO_CHECK", "50"))
GHOST_WATCHER_REACTIVATION_WINDOW_HOURS = float(os.environ.get("GHOST_WATCHER_REACTIVATION_WINDOW_HOURS", "24.0"))
GHOST_WATCHER_SINGLE_REACTIVATION_SCORE = int(os.environ.get("GHOST_WATCHER_SINGLE_REACTIVATION_SCORE", "30"))
GHOST_WATCHER_CLUSTER_SCORE = int(os.environ.get("GHOST_WATCHER_CLUSTER_SCORE", "25"))
GHOST_WATCHER_HIGH_CONCENTRATION_SCORE = int(os.environ.get("GHOST_WATCHER_HIGH_CONCENTRATION_SCORE", "20"))
GHOST_WATCHER_EXTREME_DORMANCY_SCORE = int(os.environ.get("GHOST_WATCHER_EXTREME_DORMANCY_SCORE", "15"))
GHOST_WATCHER_CEX_DESTINATION_SCORE = int(os.environ.get("GHOST_WATCHER_CEX_DESTINATION_SCORE", "10"))
GHOST_WATCHER_CLUSTER_MIN_WALLETS = int(os.environ.get("GHOST_WATCHER_CLUSTER_MIN_WALLETS", "3"))
GHOST_WATCHER_VETO_THRESHOLD = int(os.environ.get("GHOST_WATCHER_VETO_THRESHOLD", "80"))
...
_BOUNDED_0_100 = [
    ...
    ("LAUNCH_TRACKER_VETO_THRESHOLD", LAUNCH_TRACKER_VETO_THRESHOLD),
    ("GHOST_WATCHER_VETO_THRESHOLD", GHOST_WATCHER_VETO_THRESHOLD),
]
